...
var ExistMsg = 0,
    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        // SmallBox Sound
        if (isIE8orlower() == 0 && $.sound_on && settings.playSound) {
        ...
        //TODO.JT - nie dzia³a wyœwietlanie wiêcej ni¿ jednego komunikatu wiêc jak coœ siê ju¿ wyœwietlone to nie wyœwietlam kolejnych
            ...
            if (settings.buttons[i] == "[") {
                ...
                if (settings.buttons[i] == "]") {
                    ...
                    Name = "<button id='bot" + NumBottons + "-Msg" + SmartMSGboxCount +
                        "' class='btn btn-success btn-sm botTempo'> " + Name + "</button>";
                    Content += Name;
                } else {
